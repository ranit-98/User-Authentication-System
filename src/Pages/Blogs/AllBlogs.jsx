...
import { fetchAllBlogsData } from '../../Redux/Slice/AllBlogSlice'
...
const AllBlogs = () => {
  ...
  const allBlogsData=useSelector((state)=>state.allBlog.data.data)
  const status=useSelector((state)=>state.allBlog.status)
  useEffect(()=>{
    dispatch(fetchAllBlogsData())
  },[])
  console.log(allBlogsData,status);
  return (
    <>
    <Layout>
